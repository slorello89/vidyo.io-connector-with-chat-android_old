...
namespace VidyoClient
{
	public class RemoteCamera{
		...
		private delegate void OnFrameSizeUpdate(IntPtr c, int width, int height);
		...
		public interface IRegisterFrameSizeListener{
			...
			void OnFrameSizeUpdate(int width, int height);
		}
...
#endif
		private static void OnFrameSizeUpdateDelegate(IntPtr c, int width, int height){
